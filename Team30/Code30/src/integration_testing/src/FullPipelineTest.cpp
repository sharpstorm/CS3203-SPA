...
TEST_CASE("Test Full End-to-end") {
  ...
  query = "stmt s; assign a1, a2; variable v1,v2; Select <a1,v1,s> such that Follows*(a1, a2) such that Uses(a1, v1) such that Modifies(a2,v2)";
  expectedRes = unordered_set<string>({"5 x 1", "5 x 2", "5 x 3", "5 x 4", "5 x 5", "5 x 6", "5 x 7", "5 x 8", "5 x 9", "5 x 10", "5 x 11", "5 x 12",
                                       "9 z 1", "9 z 2", "9 z 3", "9 z 4", "9 z 5", "9 z 6", "9 z 7", "9 z 8", "9 z 9", "9 z 10", "9 z 11", "9 z 12",
                                       "9 x 1", "9 x 2", "9 x 3", "9 x 4", "9 x 5", "9 x 6", "9 x 7", "9 x 8", "9 x 9", "9 x 10", "9 x 11", "9 x 12",
                                       "9 i 1", "9 i 2", "9 i 3", "9 i 4", "9 i 5", "9 i 6", "9 i 7", "9 i 8", "9 i 9", "9 i 10", "9 i 11", "9 i 12"});
  launchQuery(qps.get(), query, expectedRes);
