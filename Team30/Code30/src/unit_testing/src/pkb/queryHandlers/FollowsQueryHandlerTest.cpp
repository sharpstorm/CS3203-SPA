...
TEST_CASE("FollowsQueryHandler follows(stmtNum,stmtType)") {
  ...
  auto result1 =
      test.handler.queryFollows({StmtType::None, 1}, {StmtType::Assign, 0});
  ...
  auto result2 =
      test.handler.queryFollows({StmtType::None, 2}, {StmtType::Read, 0});
...
TEST_CASE("FollowsQueryHandler follows(stmtType, stmtNum)") {
  ...
  auto result1 =
      test.handler.queryFollows({StmtType::Assign, 0}, {StmtType::None, 5});
  REQUIRE(result1.isEmpty == false);
  ...
  auto result2 =
      test.handler.queryFollows({StmtType::Read, 0}, {StmtType::None, 8});
  REQUIRE(result2.isEmpty == true);
}
...
TEST_CASE("FollowsQueryHandler follows(stmtType, stmtType)") {
  ...
  auto result1 =
      test.handler.queryFollows({StmtType::Assign, 0}, {StmtType::Read, 0});
